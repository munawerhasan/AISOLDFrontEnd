...
@Component({
  selector: 'app-masterdocument-add',
  templateUrl: './masterdocument-add.component.html',
  styleUrls: ['./masterdocument-add.component.scss']
})
export class MasterdocumentAddComponent implements OnInit {
  ...
  onSubmit() {
    ...
    this.loading = true;
    this.masterdocumentService.addMasterDocument(this.form.value)
      .pipe(first())
      .subscribe(
        data => {
          this.loading = false;
