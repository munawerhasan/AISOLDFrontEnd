...
@Component({
  selector: 'app-masterwing-add',
  templateUrl: './masterwing-add.component.html',
  styleUrls: ['./masterwing-add.component.scss']
})
export class MasterwingAddComponent implements OnInit {
  form: FormGroup;
  loading = false;
  submitted = false
  ...
  constructor( private formBuilder: FormBuilder,
    ...
    onSubmit() {
      ...
      this.loading = true;
      this.MasterwingService.addMasterWing(this.form.value)
        .pipe(first())
        .subscribe(
          data => {
            this.loading = false;
