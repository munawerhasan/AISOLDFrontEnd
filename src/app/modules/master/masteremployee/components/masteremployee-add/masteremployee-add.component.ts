...
@Component({
  selector: 'app-masteremployee-add',
  templateUrl: './masteremployee-add.component.html',
  styleUrls: ['./masteremployee-add.component.scss']
})
export class MasteremployeeAddComponent implements OnInit {
  ...
  onSubmit() {
    ...
    this.loading = true;
    this.masteremployeeService.addMasterEmployee(this.form.value)
      .pipe(first())
      .subscribe(
        data => {
          this.loading = false;
