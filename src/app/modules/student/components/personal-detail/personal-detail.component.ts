...
export class PersonalDetailComponent implements OnInit {
  ...
  onSubmit() {
    ...
    this.studentService.addPersonalDetail(this.form.value)
      .pipe(first())
      .subscribe(
        res => {
          ...
          console.log(JSON.stringify(res))
           ...
           if(res.isError===false)
           {
            ...
            this.router.navigateByUrl('/student/details/parent-detail', { relativeTo: this.route.parent, skipLocationChange: true });
