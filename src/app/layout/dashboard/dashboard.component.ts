...
export class DashboardComponent implements OnInit, OnDestroy {
  ...
  ngOnInit() {
    ...
    this.userId = this.authService.currentUserValue.id.toString();
  }
  ...
  changePassword() {
    ...
    console.log(JSON.stringify(this.f.password.value));
    this.authService.changePassword(this.f.password.value, this.authService.currentUserValue.id.toString())
      .pipe(first())
      .subscribe(
        data => {
  ...
  openStudentDetailModal(event) {
    this.studentService.getStudentByUserId(this.authService.currentUserValue.id).subscribe(res => {
      this.userDetail = res.data;
    })
    document.querySelector('#' + 'ViewStudentModel').classList.add('md-show');
  }
